            ...
            if (existingIdx > -1) {
                if (updateDuplicates) {
                    ...
                    if (type === "equipment") {
                        ...
                        listArr[existingIdx] = {
                            ...
                            returnTimeline: getProp(row, ["Return Timeline"]) || listArr[existingIdx].returnTimeline || "Project Completion",
                            totalCount: parseInt(getProp(row, ["Total Count", "qty"])) || listArr[existingIdx].totalCount || 1,
                ...
                if (type === "equipment") {
                    ...
                    newItem = {
                        ...
                        returnTimeline: getProp(row, ["Return Timeline"]) || "Project Completion",
                        totalCount: parseInt(getProp(row, ["Total Count", "qty"])) || 1,
